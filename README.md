...
[![Automated Testing](https://github.com/CommonGateway/WaardepapierenAPI/actions/workflows/tests.yml/badge.svg)](https://github.com/CommonGateway/WaardepapierenAPI/actions/workflows/tests.yml)
...
- [API Documentation (redocly is a API documentation generator)](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/CommonGateway/WaardepapierenAPI/main/OAS.yaml&nocors)
- [API Definition (yaml or json file)](https://github.com/CommonGateway/WaardepapierenAPI/blob/main/OAS.yaml)
- [Public Code (file about this API and makes it searchable)](https://github.com/CommonGateway/WaardepapierenAPI/blob/main/publiccode.yaml)
...
To use this repository as a template, you will need a [GitHub account](https://github.com/login). Make sure you have a GitHub account and are logged in on GitHub. When you are logged in you can [use this template](https://github.com/CommonGateway/WaardepapierenAPIAPI/generate), select the owner and fill in a nice name for your new repository. After creating your new repository, please follow these steps:
...
- Execute the command `git clone (link you copied) (directory you want to clone the repository to`, an example: `git clone https://github.com/CommonGateway/WaardepapierenAPIAPI.git C:\Users\JohnDoe\Projects`.
...
```bash
git clone https://github.com/CommonGateway/WaardepapierenAPIAPI.git
cd PetStoreAPI
docker-compose up
```
...
`https://raw.githubusercontent.com/CommonGateway/WaardepapierenAPIAPI/main/publiccode.yaml`
